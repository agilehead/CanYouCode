...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Bids Won: CanYouCode.com
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="content">
        <ul class='tab full'>
            <li><a href='/<%= Model.LoggedInAccount.Username %>/Projects'>Active</a></li><li
                class='selected'><a href='/<%= Model.LoggedInAccount.Username %>/Projects/Won'>Bids
                    Won</a></li><li><a href='/<%= Model.LoggedInAccount.Username %>/Projects/Lost'>Bids
                        Lost</a></li></ul>
        <div class="clear">
        </div>
